...
public class AutoMace implements ClientModInitializer {
    ...
    public static class ConfigurationRegistry {
        ...
        private final double maxAimRange = 7.0D; // 7 blocks aim range for rapid divebomb engagement
        private final double minFallDistance = 2.0D; // Minimum 2 block fall distance for mace smash
        private final float baseSmoothness = 0.50F; // Fast yet buttery smooth human interpolation
    ...
    public static class RotationManager {
        ...
        public void executeSmoothSnap(Vec3 destination, float velocityModifier) {
            ...
            // Fixed pitch calculation using correct diffY variable
