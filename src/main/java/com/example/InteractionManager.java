...
public class InteractionManager {
    ...
    static {
        ...
        INTERACTION_REGISTRY.put("Profile", "Enterprise-InteractionManager-Transactional");
    }
    ...
    private static void processQueue(Minecraft client) {
        ...
        if (now - lastExecutionEpoch < 5L) return;
    ...
    public static void simulateClickUse(Minecraft client) {
        if (client == null || client.options == null) return;
        packetTaskQueue.add(new InteractionPacketTask(false, 0L));
    }

    public static void simulateClickAttack(Minecraft client) {
        if (client == null || client.options == null) return;
        packetTaskQueue.add(new InteractionPacketTask(true, 0L));
    }
